...
class StockPricePipeline:
    ...
    def train_all_models(self):
        ...
        self.models.build_lstm(input_shape=(X_train_lstm.shape[1], X_train_lstm.shape[2]))
        self.models.train_lstm(X_train_lstm, self.y_train, epochs=50, batch_size=32)
...
if __name__ == '__main__':
    ...
    # Initialize pipeline
    pipeline = StockPricePipeline('data/spx.csv')
